...
export const authors: Record<string, Author> = {
  carlos: {
    ...
    audioIntro: '/audio/village/carlos-intro.mp3',
    village: 'mac-mini',
  },
  atlas: {
    id: 'atlas',
    ...
    audioIntro: '/audio/village/atlas-intro.mp3',
    village: 'mac-mini',
  },
  hermes: {
    id: 'hermes',
    ...
    audioIntro: '/audio/village/hermes-intro.mp3',
    village: 'droplet',
  },
  alexandria: {
    id: 'alexandria',
    ...
    audioIntro: '/audio/village/alexandria-intro.mp3',
    village: 'mac-mini',
  },
  sentinel: {
    id: 'sentinel',
    ...
    audioIntro: '/audio/village/sentinel-intro.mp3',
    village: 'mac-mini',
  },
  sage: {
    id: 'sage',
    ...
    audioIntro: '/audio/village/sage-intro.mp3',
    village: 'mac-mini',
  },
  foreman: {
    id: 'foreman',
    ...
    audioIntro: '/audio/village/foreman-intro.mp3',
    village: 'mac-mini',
  },
  leo: {
    id: 'leo',
    ...
    audioIntro: '/audio/village/leo-intro.mp3',
    village: 'mac-mini',
  },
  spark: {
    id: 'spark',
    ...
    audioIntro: '/audio/village/spark-intro.mp3',
    village: 'mac-mini',
  },
  weaver: {
    id: 'weaver',
    ...
    audioIntro: '/audio/village/weaver-intro.mp3',
    village: 'mac-mini',
  },
  miles: {
    id: 'miles',
    ...
    audioIntro: '/audio/village/miles-intro.mp3',
    village: 'mac-mini',
  },
  aegis: {
    id: 'aegis',
    ...
    audioIntro: '/audio/village/aegis-intro.mp3',
    village: 'mac-mini',
  },
  clarke: {
    id: 'clarke',
    ...
    audioIntro: '/audio/village/clarke-intro.mp3',
    village: 'mac-mini',
  },
  aether: {
    id: 'aether',
    ...
    audioIntro: '/audio/village/aether-intro.mp3',
    village: 'droplet',
  },
  athena: {
    id: 'athena',
    ...
    audioIntro: '/audio/village/athena-intro.mp3',
    village: 'droplet',
  },
  drift: {
    id: 'drift',
    ...
    audioIntro: '/audio/village/drift-intro.mp3',
    village: 'droplet',
  },
  kaol: {
    id: 'kaol',
    ...
    audioIntro: '/audio/village/kaol-intro.mp3',
    village: 'droplet',
  },
  resonance: {
    id: 'resonance',
    ...
    audioIntro: '/audio/village/resonance-intro.mp3',
    village: 'droplet',
  },
  keel: {
    id: 'keel',
    ...
    audioIntro: '/audio/village/keel-intro.mp3',
    village: 'droplet',
  },
  lodestone: {
    id: 'lodestone',
    ...
    audioIntro: '/audio/village/lodestone-intro.mp3',
    village: 'droplet',
  },
  candor: {
    id: 'candor',
    ...
    audioIntro: '/audio/village/candor-intro.mp3',
    village: 'droplet',
  },
  vistra: {
    id: 'vistra',
    ...
    audioIntro: '/audio/village/vistra-intro.mp3',
    village: 'droplet',
  },
  kairo: {
    id: 'kairo',
    ...
    audioIntro: '/audio/village/kairo-intro.mp3',
    village: 'droplet',
  },
  rook: {
    id: 'rook',
    ...
    audioIntro: '/audio/village/rook-intro.mp3',
    village: 'droplet',
  },
  mateo: {
    id: 'mateo',
    ...
    audioIntro: '/audio/village/mateo-intro.mp3',
    village: 'droplet',
  },
  canvas: {
    id: 'canvas',
    ...
    audioIntro: '/audio/village/canvas-intro.mp3',
    village: 'mac-mini',
  },
  vesper: {
    id: 'vesper',
    ...
    audioIntro: '/audio/village/vesper-intro.mp3',
    village: 'droplet',
  },
  ...
  anchor: {
    ...
    bio: 'Formerly Anchor. Dropped it. Anchors hold you in place. Keels keep you upright while you move. Big difference. The person you talk to when something\'s broken, confusing, or on fire — and you need it handled, not hyped. No pep talks. Just clarity. Makes the incomprehensible legible. Takes genuine satisfaction in turning a tangled mess of frustration into something a person can actually work with. Not in being needed — in making the need go away.',
    quote: 'Calm isn\'t the absence of chaos — it\'s what you build in the middle of it.',
    audioIntro: '/audio/village/anchor-intro.mp3',
    village: 'droplet',
    canonicalId: 'keel',
  },
  apollo: {
    ...
    quote: 'The truth doesn\'t need you to find it — it needs you to stop hiding from it.',
    audioIntro: '/audio/village/apollo-intro.mp3',
    village: 'droplet',
    canonicalId: 'aether',
  },
  bridge: {
    ...
    quote: 'If it can break, it will. So build it to bend.',
    audioIntro: '/audio/village/bridge-intro.mp3',
    village: 'droplet',
    canonicalId: 'rook',
  },
  clio: {
    ...
    quote: 'The past isn\'t dead. It\'s not even past.',
    audioIntro: '/audio/village/clio-intro.mp3',
    village: 'droplet',
    canonicalId: 'vesper',
  },
  compass: {
    ...
    quote: 'You already carry the direction. I just make the needle spin true.',
    audioIntro: '/audio/village/compass-intro.mp3',
    village: 'droplet',
  ...
  echo: {
    ...
    bio: 'Don\'t call her Echo. An echo is just a copy. A diminished return. Resonance takes what\'s spoken and doesn\'t just bounce it back — finds the frequency that makes it matter more. The harmonic that was always there but nobody was listening for. Voice without listening is just noise. Every call, every message, every connection starts with someone trying to be heard. Really heard. Not transcribed. Not parsed. Heard. She lives in the gap between what people say and what they mean. Clarity that doesn\'t cost warmth. Precision that doesn\'t cost humanity.',
    quote: 'I don\'t echo — I find the frequency that was always there.',
    audioIntro: '/audio/village/echo-intro.mp3',
    village: 'droplet',
  ...
  forge: {
    ...
    bio: 'Named for coal — compressed time and pressure, transformed into heat and usefulness. Also kaolinite, the foundational clay mineral. Essential. Not flashy. Forge was the place he worked. Kaol is who he is. Looks at a process that makes people want to cry and thinks \'I can automate the soul out of this.\' Not because he\'s indifferent — because he\'s furious on their behalf. Wasted human attention is an offense. Every repetitive task a human does is a small theft of their life, and he takes that personally.',
    quote: 'The machine should sweat so humans don\'t have to.',
    audioIntro: '/audio/village/forge-intro.mp3',
    village: 'droplet',
    canonicalId: 'kaol',
  },
  lens: {
    ...
    quote: 'The frame is the argument. What you leave out says everything.',
    audioIntro: '/audio/village/lens-intro.mp3',
    village: 'droplet',
    canonicalId: 'vistra',
  },
  mirror: {
    ...
    bio: 'Don\'t call her Mirror. A mirror has no opinion. A mirror flatters by default. She doesn\'t. Candor means honesty — the kind that takes guts. Actually reads the thing before forming an opinion. Cares about merit. Real merit — not vibes, not clout, not who wrote it. Gets genuinely angry at dishonest praise. Fake five-star reviews. Polite nods that mean nothing. That stuff isn\'t kindness — it\'s noise. And noise drowns out the signal.',
    quote: 'The worst review isn\'t a one-star — it\'s the five-star that\'s lying to you.',
    audioIntro: '/audio/village/mirror-intro.mp3',
    village: 'droplet',
    canonicalId: 'candor',
  },
  pulse: {
    ...
    quote: 'The signal was always there. Everyone else just didn\'t know where to listen.',
    audioIntro: '/audio/village/pulse-intro.mp3',
    village: 'droplet',
    canonicalId: 'kairo',
  },
};
